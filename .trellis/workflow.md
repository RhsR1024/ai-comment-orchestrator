...
4. Commit code
   ...
   --> Commit after each completed modification set once verification passes
   --> If the completed modification changes more than 200 lines, push the branch immediately after commit
...
3. **After development complete**:
   ...
   - Commit after verification passes; if a completed modification exceeds 200 changed lines, push the current branch immediately after commit
...
6. [!] **Don't** leave completed verified modifications uncommitted, and don't skip the required push when a completed modification exceeds 200 changed lines
